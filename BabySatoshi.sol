...
//
// $LTCPup earns you BTC automatically
//
// DIVIDEND YIELD PAID IN BTC! With the auto-claim feature,
// simply hold $SATS and you'll receive BTC automatically in your wallet.
// 
// Hold Baby Satoshi and get rewarded in BTC on every transaction!
//
//
// 📱 Telegram: https://t.me/babysats/
// 🌎 Website: https://www.LTCPup.app/
...
contract LTCPup is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2 * (10**18);
    ...
    address public _marketingWalletAddress = 0xee05535022f74F44581EBaBB6b6eD69aB88ff8Ba;
    ...
    constructor() public ERC20("Baby Satoshi", "SATS") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        LTCPupDividendTracker newDividendTracker = LTCPupDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "LTCPup: The new dividend tracker must be owned by the LTCPup token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "LTCPup: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "LTCPup: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "LTCPup: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "LTCPup: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "LTCPup: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "LTCPup: Cannot update gasForProcessing to same value");
...
contract LTCPupDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("LTCPup_Dividen_Tracker", "LTCPup_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 2 * (10**17); // must hold 0,2+ tokens
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "LTCPup_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "LTCPup_Dividend_Tracker: Cannot update claimWait to same value");
